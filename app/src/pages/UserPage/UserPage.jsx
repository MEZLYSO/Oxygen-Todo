  ...
  return (
    <>
      <Header
        ...
        center={<p className="text-white text-2xl font-[Open_Sans] font-bold">Cuenta</p>}
        ...
        className="flex gap-2 bg-azulf duration-300 font-bold font-[Open_Sans] text-xl rounded-xl px-5 py-2 text-white mb-3 mt-3 cursor-pointer hover:bg-red-700" >
          <LogOut /> Cerrar sesion</button>
        }
      />
      <form className="flex flex-col gap-2 items-center mt-15 h-screen bg-fondo">
        <label className="py-2 px-1 font-bold font-[Open_Sans] text-xl text-cafef">Username:</label>
        <input type="text" defaultValue={userData.username} className="border-1 text-azulf font-bold font-[Open_Sans] text-xl py-2 px-2 rounded-xl focus:outline-hidden focus:border-cafec" />
        <label className="py-2 px-1 font-bold font-[Open_Sans] text-xl text-cafef">Email:</label>
        <input type="text" defaultValue={userData.email} className="border-1 text-azulf font-bold font-[Open_Sans] text-xl py-2 px-2 rounded-xl focus:outline-hidden focus:border-cafec" />
        <label className="py-2 px-1  font-bold font-[Open_Sans] text-xl text-cafef">Password:</label>
        <input type="text" defaultValue={userData.password} className="border-1 text-azulf font-bold font-[Open_Sans] text-xl py-2 px-2 rounded-xl focus:outline-hidden focus:border-cafec" />
        <div>
